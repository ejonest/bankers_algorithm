...
void* runner(void* param) {           // thread runner
    ...
    Bank* b = c->get_bank();
                          // TODO...
    //int counter = 70;     // for debugging purposes, just stop after 50 iterations
...
// ejones@ethan-notebook:~/CPSC-351/BankersProject/bankers_example_code$ ./bank_algo bankers_tinier.txt
// buf is: 8
// buf is: 2,   3,
// buf is: 1,   4,
// buf is: 1,   2,
...
// size is 4
// P3 requesting:  2    ............. request APPROVED!
//
// +-----------------------------------------
// |   BANK   avail: [10]
// +-----------------------------------------
